...
import cadObjects.CADObjectsReader;
...
public class DXFDrawing {
    ...
    private static CADObjectsReader CADObjectsReader;
    ...
    public static CADObjectsReader getCADObjects() {
        return CADObjectsReader;
    }
    public static void setCADBlocks(CADObjectsReader cadObjectsReader) {
        CADObjectsReader = cadObjectsReader;
    }
    public static Objects getObjects() {
        return Objects;
    }
    public static void setObjects(Objects objects) {
        Objects = objects;
    }
    ...
    public DXFDrawing(Integer currentline, Integer length, fileHandlers.DXFLoad file) throws IOException {
    ...
    private static void SetPolylinesVertexesRemoveEmptyFirstCoords(Entity entity) {
